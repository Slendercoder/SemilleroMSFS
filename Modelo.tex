...
\begin{teor}
Existe un $k\,{\in}\,\mathbb{N}$ tal que $X[k]=X[k{+}1]$ si, y sólo si, existe un $p\in[0,1]$ tal que
\[p*I=|\{i\,{\in}\,\mathcal{I}:p\leq u_i\}|\] 
\end{teor}
\begin{proof}
\begin{itemize}
\item[$\Rightarrow$)] Supongamos que existe un $k\,{\in}\,\mathbb{N}$ tal que $X[k]=X[k{+}1]$ y sea $p=\frac{X[k]}{I}$. Observe que $p\in[0,1]$ y que $p*I=\frac{X[k]}{I}*I=X[k]=X[k{+}1]$. Además, observe que:
\begin{align*}
p*I&=X[k{+}1]\\
&=|\{i\,{\in}\,\mathcal{I}:\frac{X[k]}{I}\leq u_i\}|\\
&=|\{i\,{\in}\,\mathcal{I}:p\leq u_i\}|\qquad\mbox{(por definición de $p$)}\\
\end{align*}
\end{itemize}

\item[$\Leftarrow$)] Supongamos que existe un $p\in[0,1]$ tal que $p*I=|\{i\,{\in}\,\mathcal{I}:p\leq u_i\}|$ 
